...
type NotificationPreference struct {
	Common
	UserId                      string `gorm:"column:user_id;type:text;uniqueIndex;not null" json:"userId"`
	DirectMessageNotifications  bool   `gorm:"column:direct_message_notifications;not null;default:true" json:"directMessages"`
	MentionNotifications        bool   `gorm:"column:mention_notifications;not null;default:true" json:"mentions"`
	ChannelMessageNotifications bool   `gorm:"column:channel_message_notifications;not null;default:true" json:"channelMessages"`
	MeetingReminders            bool   `gorm:"column:meeting_reminders;not null;default:true" json:"meetingReminders"`
	CallNotifications           bool   `gorm:"column:call_notifications;not null;default:true" json:"incomingCalls"`
	EmailNotifications          bool   `gorm:"column:email_notifications;not null;default:true" json:"emailNotifications"`
	SoundEnabled                bool   `gorm:"column:sound_enabled;not null;default:true" json:"sounds"`
